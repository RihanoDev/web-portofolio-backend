...
type Service interface {
	...
	Update(id string, postData *models.Post) error
...
func (s *service) GetByID(id string) (*models.Post, error) {
...
func (s *service) Update(id string, postData *models.Post) error {
