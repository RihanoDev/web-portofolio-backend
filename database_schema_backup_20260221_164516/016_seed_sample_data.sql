...
SELECT 
    ...
    ARRAY['Lead development team of 5 developers', 'Architect and implement new features', 'Code review and quality assurance', 'Collaborate with product and design teams', 'Optimize application performance'],
    ARRAY['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'Docker', 'AWS'],
...
SELECT 
    ...
    ARRAY['Develop responsive web applications', 'Integrate third-party APIs', 'Database design and optimization', 'Deploy applications to cloud platforms', 'Client communication and requirement gathering'],
    ARRAY['Vue.js', 'PHP', 'Laravel', 'MySQL', 'JavaScript', 'CSS'],
...
SELECT 
    ...
    ARRAY['Implement frontend components', 'Write unit tests', 'Bug fixing and maintenance', 'Participate in agile development process', 'Learn new technologies and frameworks'],
    ARRAY['HTML', 'CSS', 'JavaScript', 'Python', 'Django', 'Git'],
